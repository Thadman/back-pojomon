class Monster < ApplicationRecord
  ...
  validates :name, presence: true, inclusion: ['Egg', 'Botomon', 'Koromon', 'Agumon', 'Betamon', 'Greymon', 'Devimon', 'Airdramon', 'Numemon', 'Tyranomon', 'Meramon', 'Seadramon', 'MetalGreymon', 'Monzaemon', 'Mamemon']
